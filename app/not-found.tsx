  ...
  return (
    <div className="min-h-screen bg-[#1b1814] flex flex-col items-center justify-center px-4 text-center">
      ...
      <div className="mt-8">
        <a
          href="/"
          className="inline-flex items-center justify-center rounded-md bg-[#ffca77] hover:bg-[#ffca77]/80 px-6 py-3 text-sm font-medium text-black shadow transition-colors"
        >
          Return Home
        </a>
      </div>
